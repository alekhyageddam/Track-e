...
THRESHOLD_COUNT = 6     #Number of consecutive detections required for detection event
...
def dbSetup():
    ...
    #Here connection and cursor are made global so that they can be used in other functions
    global connection
    global cursor
...
#This loop ensures time is taken to process data input and preform other task besides
#constantly handling sensor interrupts
while True:
    interface.sleep(0.5)
